	...
	<div class="container-body">
		...
		<div class="face-container">
			<span style="font-size: 20px; font-weight:bold;">Fa</span>
			 <button data-target="#editAttendanceModal" data-toggle="modal">open modal</button>
		</div>
...
const modelPath = '<?= base_url();?>assets/uploads/face_recognition_models';
let currentStream;
let displaySize;
let convas;
let faceDetection;
...
$(".btn-compare").on("click", function(){
    ...
    console.log(JSON.parse(distance))
    if(distance < 0.4){
    	alert("match")
    }
