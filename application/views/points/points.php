<?php if ($this->session->userdata('user_type') == "user"): ?>
    <div class="page-container points-transaction-container">
...
<?php else: ?>
	<div class="page-container points-transaction-container">
		<div class="container-header">
			<span class="header-title">List - Points Transaction</span><br>
		</div>
	...
	<script type="text/javascript" src="<?= base_url();?>assets/js/points/points-transaction.js"></script>
<?php endif ?>